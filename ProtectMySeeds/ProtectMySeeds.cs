    ...
    public class ProtectMySeeds : BaseUnityPlugin
    {
        ...
        public void Awake()
        {
            ...
            if (Chainloader.PluginInfos.TryGetValue("Therzie.WarfareFireAndIce", out var therzieFireAndIce))
            {
                ...
                {
                    Log.LogWarning(Author + "." + ModName + ": Therzie WarfareFireAndIce 2.0.7 or greater detected, which contains ProtectMySeeds code embedded. Disabling ProtectMySeeds.");
                    return;
                }
            }
